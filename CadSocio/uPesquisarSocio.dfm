object frmPesquisaDeSocio: TfrmPesquisaDeSocio
  Left = 0
  Top = 0
  ...
  object Panel1: TPanel
    ...
    object rbDesativado: TRadioButton
      AlignWithMargins = True
      Left = 263
      Top = 4
      Width = 74
  ...
  object aqrPesqSocio: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT ID_SOCIO,NOME_SOCIO,STATUS, CASE WHEN STATUS = 1 THEN '#39'AT' +
        'IVO'#39' ELSE '#39'DESATIVADO '#39' END AS SITUACAO FROM SOCIO')
    Left = 392
    Top = 224
    ...
    object aqrPesqSocioNOME_SOCIO: TStringField
      DisplayLabel = 'NOME SOCIO'
      FieldName = 'NOME_SOCIO'
      Size = 50
    end
    object aqrPesqSocioSITUACAO: TStringField
      FieldName = 'SITUACAO'
      ReadOnly = True
      Size = 11
    end
